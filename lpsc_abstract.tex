...
% you may want to add these options to biblatex: url=false,eprint=false
% to suppress printing of these fields.
...
% \usepackage{balance}			% For balancing columns on the page, and uncomment
                                % \balance below in the document.

\usepackage{authblk}            % To enable use of \title, \author, \affil, and \maketitle
...
% There are two options to specify the title and author block.  The first way
% uses the \titlearea command, the second way requires the authblk package:

%111111 \titlearea method 111111111%
%1
%1 The \titlearea command takes two arguments in curly braces {}.  The first
%1 will be used as the title, and the second as the author info.
...
%1 Here is an example with just one author:
%1
%1 \titlearea{Using \LaTeX\ to write an LPSC Abstract.}{Ross A. Beyer, NASA Ames Research Center, MS 245-3, Moffett Field, CA, USA (Ross.A.Beyer@nasa.gov)}

%1 Here is an example with more than one author from more than one place:
%1
%1 \titlearea{Using \LaTeX\ to write an LPSC Abstract.}{Ross A. Beyer$^{1,2}$, John Q. Public$^{a}$, and Jane Doe$^{\dag}$, $^1$Carl Sagan Center at the SETI Institute, $^2$NASA Ames Research Center, MS 245-3, Moffett Field, CA, USA (Ross.A.Beyer@nasa.gov), $^{a}$123 Sesame Street, New York NY, USA, $^{\dag}$890 Somewhere, ID, USA}

%222222222 authblk method 222222222222%
%2
%2 If you have a lot of authors, writing out all of those dollar signs and carets can
%2 be time consuming and error-prone.  If you uncomment the \usepackage{authblk} above,
%2 you could do the following:
%2 
%2 \title{Using \LaTeX\ to write an LPSC Abstract.}
%2 \author[1,2]{Ross A. Beyer}
%2 \affil[1]{SETI Institute, (\href{mailto:rbeyer@seti.org}{rbeyer@seti.org})}
%2 \affil[2]{NASA Ames Research Center}
%2 
%2 \author[3]{Moses Milazzo}
%2 \affil[3]{Other Orb, LLC}
%2 
%2 \author[4]{K. Michael Aye}
%2 \affil[4]{University of Colorado, Boulder}
%2 
%2 \author[5]{Lucy Lim}
%2 \affil[5]{NASA Goddard}
%2 
%2 \maketitle
